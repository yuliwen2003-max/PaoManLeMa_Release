...
public final class U implements List, Serializable, RandomAccess, InterfaceA {
    ...
    public final List subList(int i7, int i8) {
        ...
        throw new IndexOutOfBoundsException(AbstractY0.m182i(i7, i8, "fromIndex: ", ", toIndex: "));
    }
    ...
    public final ListIterator listIterator(int i7) {
        ...
        throw new IndexOutOfBoundsException(AbstractH.b("Index: ", i7));
    }
